...
function initIUGoogleMap(iu){
	...
	var panControl = $(iu).attr('panControl') == 'true';
	var option = {
...
function resizeIUGoogleMap(iu){
	...
	var parentPreDisplay = $(displayNoneParent).css('display');
	var preDisplay = $(iu).css('display');
	...
	$(displayNoneParent).css({visibility: "", display: parentPreDisplay });
}
